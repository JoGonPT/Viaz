...
if ($partner['status'] !== 'active') {
    ...
    echo '<p class="alert alert-warning">A tua conta de parceiro está pendente de aprovação por um administrador. Vais poder usar o mural depois de seres aprovado.</p>';
